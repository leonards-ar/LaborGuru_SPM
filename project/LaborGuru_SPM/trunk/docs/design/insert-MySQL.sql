...
insert into tbl_menu_items (menu_item_id, label_key, help_key, parent_id, permission_id, position, target) values (null, 'employee.submenu.list', 'EMPLOYEE_LIST_HELP', 2, 3, 0, '/employee/employee_list.action');
insert into tbl_menu_items (menu_item_id, label_key, help_key, parent_id, permission_id, position, target) values (null, 'employee.submenu.create', 'EMPLOYEE_ADD_HELP', 2, 4, 1, '/employee/employee_add.action');

-- Store
insert into tbl_stores (store_id, name, office_id) values (null,'microcentro', 1);
