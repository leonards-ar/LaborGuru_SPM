...
public class SpmUncheckedException extends RuntimeException {
	 ...
	 */
	public SpmUncheckedException(Throwable t, String reason, ErrorEnum errorCode, Object[] arrayObjects){
		super(reason, t);
	 ...
	 * @param arrayObjects array of additional parameter objects
	 */
	public SpmUncheckedException(String reason, ErrorEnum errorCode, Object[] arrayObjects){
		super(reason);
		this.errorMessage = new ErrorMessage(errorCode.name(), arrayObjects);
	}	
