...
<table border="0" cellspacing="0" align="center">
	...
	<tr>
		...
		<display:table name="userList" class="results" pagesize="5" requestURI="regionalUser_list.action" sort="list" defaultsort="1">		    
		    ...
		    <display:column href="regionalUser_show.action" paramId="userId" paramProperty="id" class="resultsColumnCentered">
		    	<img src="<s:url value="/images/view.png" includeParams="none"/>"/>
		    </display:column>
		    <display:column href="regionalUser_edit.action" paramId="userId" paramProperty="id" class="resultsColumnCentered">
		    	<img src="<s:url value="/images/edit.png" includeParams="none"/>"/>
		    </display:column>		    
		    <display:column href="regionalUser_remove.action" paramId="userId" paramProperty="id" class="resultsColumnCentered"> 
    ...
    <tr>
     ...
     <s:form theme="simple">
       ...
       <s:hidden name="regionId" value="%{getText(region.id)}" theme="simple"/>
