...
<%@ taglib prefix="s" uri="/struts-tags"%>
	      ...
	      <table border="0" cellspacing="0" align="center">
              ...
              <tr>                            
              <td align="center">              
              <s:form name="demowizard_form" id="demowizard_form" action="demowizard_step4" theme="simple">
              	...
              	<tr class="editFormOddRow">
                    <td width="100%" align="right" colspan="2">
	                    <table border="0" cellpadding="1" cellspacing="5" colspan="0" cellspan="0">
		                    <tr>
		                    	<td><s:submit name="backButton" id="backButton" key="back.button" action="demowizard_step2" theme="simple" cssClass="button" onclick="demowizard_form.actionButton.value='back';"/></td>
