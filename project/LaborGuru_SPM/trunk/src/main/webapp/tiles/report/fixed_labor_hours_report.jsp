...
<table id="windowReportTable" cellspacing="0">
	...
	<tr>
		...
		<td class="greyTableValueWithLeftBottomBorder">
		  <s:text name="total.hours"><s:param value="fixedLaborHoursReport.totalSchedule" /></s:text>
		</td>
		<s:push value="fixedLaborHoursReport.schedule">
			<td class="tableValueWithLeftBottomBorder"><s:text name="total.hours"><s:param value="serviceHours"/></s:text></td>
			<td class="tableValueWithLeftBottomBorder"><s:text name="total.hours"><s:param value="openHours"/></s:text></td>
			<td class="tableValueWithLeftBottomBorder"><s:text name="total.hours"><s:param value="flexHours"/></s:text></td>
			<td class="tableValueWithLeftBottomBorder"><s:text name="total.hours"><s:param value="closeHours"/></s:text></td>		
		</s:push>
	<tr>
	<tr>
		...
		<s:push value="fixedLaborHoursReport.target">
			...
			<td class="tableValueWithLeftBorder"><s:text name="total.hours"><s:param value="openHours"/></s:text></td>
			<td class="tableValueWithLeftBorder"><s:text name="total.hours"><s:param value="flexHours"/></s:text></td>
			<td class="tableValueWithLeftBorder"><s:text name="total.hours"><s:param value="closeHours"/></s:text></td>		
		</s:push>
	</tr>
	<tr>
		...
		<s:push value="fixedLaborHoursReport.difference">
			...
			<td class="greyTableValueWithLeftBorder"><s:text name="total.hours"><s:param value="openHours"/></s:text></td>
			<td class="greyTableValueWithLeftBorder"><s:text name="total.hours"><s:param value="flexHours"/></s:text></td>
			<td class="greyTableValueWithLeftBorder"><s:text name="total.hours"><s:param value="closeHours"/></s:text></td>		
		</s:push>		
	</tr>
</table>