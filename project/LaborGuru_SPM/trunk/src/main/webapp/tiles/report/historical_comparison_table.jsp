  ...
  <table>
	...
	<tr>
		<td class="windowTableValue">
			<s:text name="report.historicalComparison.date"><s:param value="day"/></s:text>
		</td>	
		<td class="windowTableValue">
			<s:text name="currency"> <s:param value="schedule"/></s:text>
		</td>
		<td class="windowTableValue">
			<s:text name="currency"><s:param value="target" /></s:text>
		</td>
		<td class="windowTableValue">
			<s:text name="currency"><s:param value="difference"/></s:text>
		</td>
		<td class="windowTableValue">
			<s:text name="report.historicalComparison.percentage"><s:param value="percentaje" /></s:text>
		</td>
	</tr>
	</s:iterator>
