...
<table border="0" cellspacing="0" align="center">
	...
	<tr>
		<td id="subtitleBar" nowrap><s:text name="store.laborallowance.title" /> - <s:text name="store.laborallowance.fixedflexible.title" /></td>
	</tr>

	<tr>
		<td align="center">
              <s:form action="storeFixedFlexible_save" theme="simple">
							...
							<s:iterator id="position" value="store.orderedPositions" status="pStatus">
								<tr>
									...
									<s:iterator id="dayOfWeekName" value="dayOfWeekNames" status="dowStatus">
										...
										<s:textfield name="dayOfWeekValues[%{#pStatus.index}][%{#dowStatus.index}]" size="8" maxlength="10"/>
										</td>
									</s:iterator>
								</tr>
							</s:iterator>
							<tr>
								<td colspan="<s:property value="%{dayOfWeekNames.size + 1}"/>" class="infoMessage"><s:text name="store.laborallowance.fixedflexible.message" /></td>		
							</tr>						
						</table>
					</td>
				</tr>
