...
<table border="0" cellspacing="0" align="center">
	...
	<tr>
		<td id="subtitleBar" nowrap><s:text name="store.laborallowance.title" /> - <s:text name="store.laborallowance.variableflexible.title" /></td>
	</tr>

	<tr>
		<td align="center">
              <s:form action="storeVariableFlexible_save" theme="simple">
				...
				<tr class="editFormEvenRow">
					<td>
						<table border="0" cellpadding="3" cellspacing="1" align="center">
							...
							<tr>
								<td colspan="<s:property value="%{store.dayParts.size + 1}"/>" class="infoMessage"><s:text name="store.laborallowance.variableflexible.message" /></td>		
							</tr>						
						</table>
					</td>
				</tr>
