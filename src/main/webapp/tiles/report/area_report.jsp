...
<table border="0" cellspacing="0" align="center">
  ...
  <tr>
    <td align="center">
    <table border="0" cellspacing="0" align="center">
    <s:form id="areaReport_form" name="areaReport_form" theme="simple" method="post">
      <tr>
        <td>
            <table border="0" cellspacing="0" align="center">
              <tr>
        ...
        <tr>
          <td align="right">
            <s:submit id="submit" onclick="return showWaitSplash();" key="report.historicalComparison.submit.label" action="areaReport_showReport" theme="simple" cssClass="button"/>
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
