...
<table border="0" cellspacing="0" align="center">
  ...
  <tr>
    ...
    <table border="0" cellspacing="0" align="center">
      <tr>
        <td><s:form id="areaReport_form"
          name="areaReport_form" theme="simple" method="post"
          action="areaReport_showReport">
          <table border="0" cellspacing="0" align="center">
            <tr>
      ...
      <tr>
        <td align="right"><s:submit id="submit"
          ...
          targets="tableFrame" indicator="areaReportIndicator"
          formId="areaReport_form" /></td>
      </tr>
      </s:form>
      </td>
      </tr>
  ...
  <tr>
    <td align="center"><s:div id="tableFrame" theme="ajax"
      indicator="areaReportIndicator" /></td>
  </tr>

</table>

<center><img id="areaReportIndicator"
  style="display: none;"
