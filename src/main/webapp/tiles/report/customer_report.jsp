...
<table border="0" cellspacing="0" align="center">
  ...
  <tr>
    ...
    <table border="0" cellspacing="0" align="center">
      <tr>
        <td><s:form id="customerReport_form"
          name="customerReport_form" theme="simple" method="post"
          action="customerReport_showReport">
          <table border="0" cellspacing="0" align="center">
            <tr>
      ...
      <tr>
        <td align="right"><s:submit id="submit"
          ...
          targets="tableFrame" indicator="customerReportIndicator"
  ...
  <tr>
    <td align="center"><s:div id="tableFrame" theme="ajax"
      indicator="customerReportIndicator" /></td>
  </tr>
