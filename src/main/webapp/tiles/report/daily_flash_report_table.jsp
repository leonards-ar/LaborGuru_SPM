...
<div id="dailyFlashTable" border="0" cellspacing="0" align="center">
    <div class="widowTableHeader">
    ...
    <div width="100%">
        ...
        <s:if test="%{isSecondaryVariablesConfigured(1)}">
            ...
            <div>
                <span align="right" valign="middle"><input id="saveFlashReport" type="submit" value="<s:text name="save.button"/>" class="button" /></span>
            </div>
            </div>
        </s:if>
        <s:else>
            <div>
              <span align="right" colspan="2" valign="middle"><input id="saveFlashReport" type="submit" value="<s:text name="save.button"/>" class="button" /></span>
            </div>
        </s:else>
