                  					...
                  					<tr>
                  						<s:iterator id="prevDate" value="weekDaySelector.previousStartingWeekDays" status="itPrevDate">
			                  				<td class="calendarTableColumn" width="10%" nowrap="nowrap">
			                  					<a href="<s:url value="#" includeParams="none"/>" onclick="showWaitSplash(); dailyReport_form.action='addshiftbyemployee_changeWeek.action'; dailyReport_form.selectedDate.value='<s:text name='report.weekdayselector.weekdayselector.input.dateformat'><s:param value='prevDate'/></s:text>'; dailyReport_form.submit();" class="calendarUnselectedWeekLink">
			              	...
			              	<td align="center" class="calendarWeekDayTableColumn">
								<table align="center" border="0" cellpadding="0" cellspacing="0" colspan="0" cellspan="0">
                  					<tr>
                  						...
                  						<s:else>
                  						<td width="12%" class="availableWeekDay"><a href="<s:url value="#" includeParams="none"/>" onclick="showWaitSplash(); dailyReport_form.action='addshiftbyemployee_changeDay.action'; dailyReport_form.selectedWeekDay.value='<s:text name='report.weekdayselector.input.dateformat'><s:param value='weekDay'/></s:text>'; dailyReport_form.submit();" class="availableWeekDayLink">
			...
			<td align="center">
				...
				<tr>
				    ...
				    <td align="left"><s:select id="selectGrouping" name="selectedGrouping" list="groupingMap" listKey="key" listValue="%{getText(value)}" onchange="controller.changed()" theme="simple" /></td>
	 				<td>&nbsp;</td>
	 				<td align="left"><s:div  id="selectItemDiv" formId="dailyReport_form" href="%{positionAutoCompleter}" theme="ajax" listenTopics="/Changed"/></td>						
				</tr>
				</table>
			</td>
		</tr>
